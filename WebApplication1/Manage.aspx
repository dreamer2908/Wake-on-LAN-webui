...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView CssClass="fullborder" ID="ComputersGridView" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="id" AutoGenerateColumns="True" AutoGenerateDeleteButton="true"></asp:GridView>
        </div>
    </form>
</body>
</html>
